...
{
    public partial class FormMainBG : Form
    {
        ...
        private void LoadReleases()
        {
            ...
            var decodedMods = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/Way2C00L/MonkeModManager-New-Mods-/main/mods-info.json"));
            var decodedGroups = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/Way2C00L/MonkeModManager-New-Mods-/main/group-info.json"));
        ...
        private string DownloadSite(string URL)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    MessageBox.Show("Failed to update version info, please check your internet connection. This could also be a bug with the mods-info.json file. Error: " + ex.Message, this.Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
...
#region RegHelper
        ...
        {
            UpdateStatus("This feature isn't finished yet.");
        }
